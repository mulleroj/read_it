...
const CATEGORY_LEGEND = [
  ...
  { id: 'cat-r-controlled', label: 'R-Controlled', active: true },
  { id: 'cat-diphthongs', label: 'Diphthongs', active: true },
  { id: 'cat-soft-cg', label: 'Soft C / G', active: true },
  { id: 'cat-double-consonants', label: 'Double Consonants', active: true },
];
